        ...
        <Container size="lg">
          ...
          >
            <Stack gap="xl">
              ...
              <Text fz="lg" c="dimmed">
                GrantTracker centralizes deadlines, tasks, and collaborator updates so your team can
        ...
        <Container size="lg">
          ...
          >
            <Stack gap="md">
              ...
              <Title order={2}>
                "GrantTracker reduced our review cycles from weeks to days."
              </Title>
        ...
        >
          <Stack align="center" gap="lg">
            ...
            <Text ta="center" c="dimmed" maw={520}>
              Launch GrantTracker across your organization in under two weeks with guided onboarding
