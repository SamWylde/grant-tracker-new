        ...
        <Container size="lg">
          ...
          >
            <Stack gap="lg">
              ...
              <Anchor component={Link} to="/" c="dark" onClick={() => setMobileMenuOpened(false)}>
                Product
              </Anchor>
        ...
        >
          <Stack align="center" gap="lg">
            ...
            <Text ta="center" c="dimmed" maw={520}>
              Join teams that have already streamlined their grant management workflow with GrantQue.
            </Text>
