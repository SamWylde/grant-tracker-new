...
const GRANTS_GOV_TESTS = [
  ...
  {
    id: 'grants-details',
    name: 'Grants.gov - Fetch Opportunity',
    endpoint: 'https://api.grants.gov/v1/api/fetchOpportunity',
    method: 'POST',
    defaultBody: JSON.stringify({
      opportunityId: 352598,
    }, null, 2),
  },
];
...
const INTERNAL_API_TESTS = [
  {
    id: 'saved-grants',
    name: 'Internal - Get Saved Grants',
    endpoint: '/api/saved',
    method: 'GET',
    requiresAuth: true,
  },
  ...
  {
    id: 'grant-comments',
    name: 'Internal - Grant Comments',
    endpoint: '/api/comments/grant-comments',
    method: 'GET',
    requiresAuth: true,
    note: 'Requires grant_id query parameter (add manually)',
  },
  {
    id: 'webhooks',
    name: 'Internal - Get Webhooks',
  ...
  {
    id: 'integrations',
    name: 'Internal - Get Integrations',
      ...
      <Stack gap="lg">
        <div>
          ...
          <Text size="sm" c="dimmed" mt="xs">
            Test external and internal APIs to verify connectivity and functionality
          </Text>
        </div>

        <Divider />

        <Tabs value={activeTab} onChange={(value) => setActiveTab(value || 'external')}>
          <Tabs.List>
          ...
          <Tabs.Panel value="external" pt="lg">
            <Stack gap="md">
              <Text size="sm" c="dimmed">
                Test connectivity to external APIs like Grants.gov
              </Text>

              <Paper p="md" withBorder>
                <Stack gap="md">
                  {GRANTS_GOV_TESTS.map((test) => (
          ...
          <Tabs.Panel value="internal" pt="lg">
            <Stack gap="md">
              <Text size="sm" c="dimmed">
                Test your internal API endpoints
              </Text>
